...
do
    ...
    assertEqual(#included, 9, "server should include shared modules")
    assertEqual(#sent, 11, "server should send shared and client modules")
    ...
    assertEqual(sent[11], "geblib/visuals.lua", "last client module sent")
...
do
    ...
    assertEqual(#included, 11, "client should include shared and client modules")
    ...
    assertEqual(included[11], "geblib/visuals.lua", "last client module included")
