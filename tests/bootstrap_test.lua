...
do
    ...
    assertEqual(#included, 12, "server should include shared modules")
    assertEqual(#sent, 20, "server should send shared, client, and support modules")
    ...
    assertEqual(included[12], "geblib/net_selftest.lua", "network self-test loads last")
    assertEqual(sent[13], "geblib/drawing.lua", "first client module sent")
    assertEqual(sent[14], "geblib/visuals.lua", "client visual facade sent")
    assertEqual(sent[20], "geblib/visuals_decal.lua", "last client support module sent")
...
do
    ...
    assertEqual(#included, 14, "client should include shared and client modules")
    assertEqual(#sent, 0, "client should not send Lua files")
    assertEqual(included[13], "geblib/drawing.lua", "first client module included")
    assertEqual(included[14], "geblib/visuals.lua", "last client module included")
