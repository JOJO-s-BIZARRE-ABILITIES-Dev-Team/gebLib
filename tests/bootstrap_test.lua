...
do
    ...
    assertEqual(#included, 10, "server should include shared modules")
    assertEqual(#sent, 12, "server should send shared and client modules")
    assertEqual(included[1], "geblib/net.lua", "network module should load first")
    assertEqual(included[2], "geblib/entities.lua", "first gameplay module")
    assertEqual(included[9], "geblib/sound.lua", "last shared module")
    assertEqual(included[10], "geblib/net_selftest.lua", "network self-test loads last")
    assertEqual(sent[11], "geblib/drawing.lua", "first client module sent")
    assertEqual(sent[12], "geblib/visuals.lua", "last client module sent")
...
do
    ...
    assertEqual(#included, 12, "client should include shared and client modules")
    ...
    assertEqual(included[12], "geblib/visuals.lua", "last client module included")
