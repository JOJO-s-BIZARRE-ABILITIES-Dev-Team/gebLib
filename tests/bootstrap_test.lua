...
do
    ...
    assertEqual(#sent, 33, "server should send shared, client, and support modules")
    ...
    assertEqual(included[11], "geblib/visuals/surface.lua", "server debris model precaching")
    ...
    assertEqual(sent[26], "geblib/visuals/surface.lua", "first visual support module sent")
    assertEqual(sent[33], "geblib/visuals/decal.lua", "last visual support module sent")
