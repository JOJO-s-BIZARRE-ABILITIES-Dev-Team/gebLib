...
do
    ...
    assertEqual(#included, 11, "server should include shared modules")
    assertEqual(#sent, 19, "server should send shared, client, and support modules")
    ...
    assertEqual(included[11], "geblib/net_selftest.lua", "network self-test loads last")
    ...
    assertEqual(sent[19], "geblib/visuals_decal.lua", "last client support module sent")
...
do
    ...
    assertEqual(#included, 13, "client should include shared and client modules")
    ...
    assertEqual(included[13], "geblib/visuals.lua", "last client module included")
