...
do
    ...
    assertEqual(#included, 12, "server should include shared modules and debris precaching")
    assertEqual(#sent, 29, "server should send shared, client, and support modules")
    ...
    assertEqual(included[4], "geblib/net_profile.lua", "network profile implementation")
    assertEqual(included[5], "geblib/net.lua", "network module should precede gameplay modules")
    assertEqual(included[6], "geblib/entities.lua", "first gameplay module")
    assertEqual(included[11], "geblib/sound.lua", "last shared gameplay module")
    assertEqual(included[12], "geblib/visuals_surface.lua", "server debris model precaching")
    assertEqual(sent[12], "geblib/drawing.lua", "first client module sent")
    assertEqual(sent[13], "geblib/visuals.lua", "client visual facade sent")
    assertEqual(sent[23], "geblib/impact_frames.lua", "last client module sent")
    assertEqual(sent[29], "geblib/visuals_decal.lua", "last client support module sent")
...
do
    ...
    assertEqual(#included, 23, "client should include shared and client modules")
    assertEqual(#sent, 0, "client should not send Lua files")
    assertEqual(included[12], "geblib/drawing.lua", "first client module included")
    assertEqual(included[13], "geblib/visuals.lua", "visual facade included")
    assertEqual(included[23], "geblib/impact_frames.lua", "last client module included")
