...
do
    ...
    assertEqual(#included, 8, "server should include shared modules")
    assertEqual(#sent, 10, "server should send shared and client modules")
    assertEqual(included[1], "geblib/entities.lua", "first shared module")
    assertEqual(included[8], "geblib/sound.lua", "last shared module")
    assertEqual(sent[9], "geblib/drawing.lua", "first client module sent")
    assertEqual(sent[10], "geblib/visuals.lua", "last client module sent")
...
do
    ...
    assertEqual(#included, 10, "client should include shared and client modules")
    assertEqual(#sent, 0, "client should not send Lua files")
    assertEqual(included[9], "geblib/drawing.lua", "first client module included")
    assertEqual(included[10], "geblib/visuals.lua", "last client module included")
