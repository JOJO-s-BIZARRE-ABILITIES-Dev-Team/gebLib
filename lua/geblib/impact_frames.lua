...
-- Reusable impact-frame interface:
...
local paleWarm = Color(255, 246, 224)
local blueInk = Color(10, 29, 43)
local cyan = Color(184, 239, 255)
local deepNavy = Color(5, 8, 18)
local hotOrange = Color(255, 119, 20)
local golden = Color(255, 194, 48)
...
local function DrawBackground(color, alpha, screenWidth, screenHeight)
...
local function DrawTexture(material, color, alpha, focusX, focusY, screenWidth, screenHeight, scale, rotation)
    if not material or material:IsError() or alpha <= 0 then return end

    local materialWidth = math.max(material:Width(), 16)
    local materialHeight = math.max(material:Height(), 9)
    local materialAspect = materialWidth / materialHeight
    ...
    surface.SetDrawColor(color.r, color.g, color.b, alpha)
    surface.DrawTexturedRectRotated(focusX, focusY, width, height, rotation)
end
...
local function DrawExposureOverlay(instance, exposure, art, localProgress, effectScale, usedShader, maskAvailable, maskEnabled, focusX, focusY, directionX, directionY, screenWidth, screenHeight)
    ...
    if not usedShader then
        local sceneMix = 1 - (1 - (tonumber(exposure.SceneMix) or 0)) * effectScale
        DrawBackground(paper, 255 * (1 - sceneMix), screenWidth, screenHeight)
    end
    ...
    DrawTexture(
        texture,
        exposure.TextureColor or ink,
        textureAlpha,
        focusX,
        focusY,
        screenWidth,
        screenHeight,
        (tonumber(exposure.TextureScale) or 1.05) * art.TextureScale,
        directionDegrees + instance.Rotation + art.Rotation + (tonumber(exposure.TextureRotation) or 0)
    )
...
impactFrames.RegisterSequence("quick", {
    {Weight = 1, SceneMix = 0, Paper = white, Ink = black, Star = true, StarScale = 0.1, StarAlpha = 1},
    {Weight = 1, SceneMix = 0, Paper = black, Ink = white, MaskStrength = 1, LineDensity = 0.35, LineAlpha = 0.8},
    {Weight = 2, SceneMix = 0.55, Paper = paleBlue, Ink = blueInk, Posterize = 0.75, EdgeStrength = 4, Texture = "radial", TextureAlpha = 0.4, LineDensity = 0.3, LineAlpha = 0.55},
    {Weight = 2, SceneMix = 1, Paper = paleBlue, Ink = blueInk, Posterize = 0.18, EdgeStrength = 1.2, Smear = 7, Texture = "fragments", TextureAlpha = 0.22, FadeOut = true}
})

impactFrames.RegisterSequence("default", {
    {Weight = 2, SceneMix = 0.6, Paper = paleBlue, Ink = blueInk, Posterize = 0.85, EdgeStrength = 5.5, Radial = 0.008, Texture = "radial", TextureAlpha = 0.38, LineDensity = 0.4, LineAlpha = 0.55},
    {Weight = 1, SceneMix = 0, Paper = white, Ink = black, Star = true, StarScale = 0.12, StarAlpha = 1},
    {Weight = 2, SceneMix = 0, Paper = black, Ink = white, MaskStrength = 1, Texture = "slashes", TextureAlpha = 0.24, LineDensity = 0.65, LineAlpha = 0.9},
    {Weight = 2, SceneMix = 0, Paper = white, Ink = black, MaskStrength = 1, Texture = "radial", TextureAlpha = 0.42, LineDensity = 0.55, LineAlpha = 0.75},
    {Weight = 3, SceneMix = 1, Paper = paleBlue, Ink = blueInk, Posterize = 0.22, EdgeStrength = 1.5, Smear = 9, Texture = "fragments", TextureAlpha = 0.3, FadeOut = true}
})

impactFrames.RegisterSequence("heavy", {
    {Weight = 2, SceneMix = 0.5, Paper = paleWarm, Ink = black, Posterize = 0.9, EdgeStrength = 6, Radial = 0.012, Texture = "radial", TextureAlpha = 0.52, LineDensity = 0.55, LineAlpha = 0.68},
    {Weight = 1, SceneMix = 0, Paper = white, Ink = black, Star = true, StarScale = 0.15, StarAlpha = 1},
    {Weight = 2, SceneMix = 0, Paper = black, Ink = white, MaskStrength = 1, Star = true, StarScale = 0.12, StarAlpha = 0.9, Texture = "slashes", TextureAlpha = 0.3, LineDensity = 0.8, LineAlpha = 0.95},
    {Weight = 3, SceneMix = 0, Paper = white, Ink = black, MaskStrength = 1, Texture = "radial", TextureAlpha = 0.58, LineDensity = 0.85, LineAlpha = 0.85},
    {Weight = 2, SceneMix = 0, Paper = black, Ink = white, MaskStrength = 1, Texture = "fragments", TextureAlpha = 0.52, LineDensity = 0.6, LineAlpha = 0.72},
    {Weight = 4, SceneMix = 1, Paper = paleWarm, Ink = black, Posterize = 0.25, EdgeStrength = 1.8, Radial = 0.006, Smear = 14, Texture = "fragments", TextureAlpha = 0.36, FadeOut = true}
})

impactFrames.RegisterSequence("serious_punch", {
    {Weight = 2, SceneMix = 0.58, Paper = paleBlue, Ink = blueInk, Posterize = 0.92, EdgeStrength = 7, Radial = 0.012, Texture = "radial", TextureAlpha = 0.58, LineDensity = 0.55, LineAlpha = 0.68, DirectionBias = 0.82},
    {Weight = 2, SceneMix = 0, Paper = black, Ink = white, MaskStrength = 1, Star = true, StarColor = cyan, StarScale = 0.18, StarAlpha = 1, Texture = "slashes", TextureAlpha = 0.34, LineDensity = 0.92, LineAlpha = 0.92, LineColor = white, DirectionBias = 0.88},
    {Weight = 1, SceneMix = 0, Paper = white, Ink = black, Star = true, StarColor = white, StarScale = 0.22, StarAlpha = 1},
    {Weight = 3, SceneMix = 0, Paper = white, Ink = black, MaskStrength = 1, Star = true, StarColor = white, StarScale = 0.14, StarAlpha = 0.9, Texture = "radial", TextureAlpha = 0.64, LineDensity = 1, LineAlpha = 0.9, DirectionBias = 0.9, Expansion = 1.08},
    {Weight = 2, SceneMix = 0, Paper = black, Ink = white, MaskStrength = 1, Texture = "slashes", TextureAlpha = 0.62, LineDensity = 0.85, LineAlpha = 0.82, DirectionBias = 0.84, Expansion = 1.12},
    {Weight = 3, SceneMix = 0.5, Paper = paleBlue, Ink = blueInk, Posterize = 1, EdgeStrength = 8, MaskStrength = 0.12, Radial = -0.01, Texture = "fragments", TextureAlpha = 0.72, LineDensity = 0.65, LineAlpha = 0.62, DirectionBias = 0.78},
    {Weight = 4, SceneMix = 1, Paper = paleWarm, Ink = blueInk, Posterize = 0.32, EdgeStrength = 2, Radial = 0.008, Smear = 20, Texture = "fragments", TextureAlpha = 0.42, LineDensity = 0.28, LineAlpha = 0.28, DirectionBias = 0.9, FadeOut = true}
})

impactFrames.RegisterSequence("ultimate_impact", {
    {
        Weight = 2, SceneMix = 0.86, Paper = paleBlue, Ink = blueInk,
        Posterize = 0.22, EdgeStrength = 1.5, Radial = 0.002,
        AttackerMaskStrength = 0.12, AttackerColor = blueInk,
        Texture = "radial", TextureAlpha = 0.08, LineDensity = 0.08, LineAlpha = 0.14
    },
    {
        Weight = 1, SceneMix = 0, Paper = white, Ink = black,
        AttackerMaskStrength = 0.18, AttackerColor = blueInk,
        VictimMaskStrength = 1, VictimColor = black,
        LineDensity = 0.12, LineAlpha = 0.18
    },
    {
        Weight = 1, SceneMix = 0, Paper = deepNavy, Ink = white,
        AttackerMaskStrength = 0.28, AttackerColor = cyan,
        VictimMaskStrength = 1, VictimColor = white,
        ContactCore = true, CoreScale = 0.12, CoreOuterColor = cyan, CoreColor = white, CoreNegativeColor = deepNavy,
        Texture = "slashes", TextureAlpha = 0.28, LineDensity = 0.45, LineAlpha = 0.72, LineColor = white, DirectionBias = 0.94
    },
    {
        Weight = 1, SceneMix = 0.14, Paper = paleWarm, Ink = black,
        Posterize = 1, EdgeStrength = 9, EtchStrength = 1, Radial = -0.006,
        AttackerMaskStrength = 0.82, AttackerColor = black,
        VictimMaskStrength = 0.96, VictimColor = black,
        ContactCore = true, CoreScale = 0.14, CoreOuterColor = black, CoreColor = white, CoreNegativeColor = paleWarm,
        Texture = "slashes", TextureAlpha = 0.5, LineDensity = 0.92, LineAlpha = 0.82, DirectionBias = 0.9
    },
    {
        Weight = 1, SceneMix = 0, Paper = white, Ink = black,
        AttackerMaskStrength = 0.08, AttackerColor = black,
        VictimMaskStrength = 0.22, VictimColor = black,
        ContactCore = true, CoreScale = 0.21, CoreOuterColor = black, CoreColor = white, CoreNegativeColor = white,
        Star = true, StarColor = white, StarScale = 0.24, StarAlpha = 1,
        Texture = "radial", TextureAlpha = 0.7, LineDensity = 1, LineAlpha = 0.92, DirectionBias = 0.94, Expansion = 1.16
    },
    {
        Weight = 1, SceneMix = 0, Paper = deepNavy, Ink = white,
        AttackerMaskStrength = 0.3, AttackerColor = cyan,
        VictimMaskStrength = 0.68, VictimColor = white,
        ContactCore = true, CoreScale = 0.17, CoreOuterColor = cyan, CoreColor = white, CoreNegativeColor = deepNavy,
        Star = true, StarColor = white, StarScale = 0.12, StarAlpha = 0.9,
        LineDensity = 0.34, LineAlpha = 0.58, LineColor = white, DirectionBias = 0.96
    },
    {
        Weight = 1, SceneMix = 0.08, Paper = hotOrange, Ink = warmWhite,
        Posterize = 0.92, EdgeStrength = 7, EtchStrength = 0.18, Radial = 0.014,
        AttackerMaskStrength = 0.24, AttackerColor = warmWhite,
        VictimMaskStrength = 0.9, VictimColor = deepNavy,
        ContactCore = true, CoreScale = 0.2, CoreOuterColor = hotOrange, CoreColor = warmWhite, CoreNegativeColor = deepNavy,
        EnergyRibbons = true, RibbonIntensity = 0.68, RibbonOuterColor = hotOrange, RibbonCoreColor = warmWhite,
        Texture = "radial", TextureColor = golden, TextureAlpha = 0.72, LineDensity = 0.65, LineAlpha = 0.72, LineColor = warmWhite, DirectionBias = 0.96
    },
    {
        Weight = 2, SceneMix = 0.56, Paper = golden, Ink = deepNavy,
        Posterize = 0.66, EdgeStrength = 4.5, Radial = -0.008, Smear = 28,
        AttackerMaskStrength = 0.2, AttackerColor = warmWhite,
        VictimMaskStrength = 0.72, VictimColor = deepNavy,
        EnergyRibbons = true, RibbonIntensity = 1.18, RibbonOuterColor = hotOrange, RibbonCoreColor = warmWhite,
        ContactCore = true, CoreScale = 0.13, CoreOuterColor = hotOrange, CoreColor = warmWhite, CoreNegativeColor = golden,
        Texture = "fragments", TextureColor = hotOrange, TextureAlpha = 0.42, LineDensity = 0.42, LineAlpha = 0.46, LineColor = warmWhite, DirectionBias = 0.96, Expansion = 1.2
    },
    {
        Weight = 3, SceneMix = 1, Paper = paleWarm, Ink = blueInk,
        Posterize = 0.28, EdgeStrength = 2, Radial = 0.006, Smear = 18,
        EnergyRibbons = true, RibbonIntensity = 0.52, RibbonOuterColor = golden, RibbonCoreColor = warmWhite,
        Texture = "fragments", TextureColor = hotOrange, TextureAlpha = 0.48,
        LineDensity = 0.24, LineAlpha = 0.26, DirectionBias = 0.92, FadeOut = true
    }
})

impactFrames.RegisterPreset("default", {
    Duration = 0.16,
    Intensity = 1,
    LineCount = 72,
    FrameJitter = 0.8,
...
impactFrames.RegisterPreset("quick", {
    Duration = 0.1,
    Intensity = 0.8,
    LineCount = 54,
    FrameJitter = 0.65,
...
impactFrames.RegisterPreset("heavy", {
    Duration = 0.21,
    Intensity = 1.25,
    LineCount = 92,
    FrameJitter = 1,
...
impactFrames.RegisterPreset("serious_punch", {
    Duration = 0.26,
    Intensity = 1.45,
    LineCount = 112,
    FrameJitter = 1.15,
    ...
    FocusY = 0.48,
    Rotation = -5,
    Sequence = "serious_punch"
})

impactFrames.RegisterPreset("ultimate_impact", {
    Duration = 0.3,
    Intensity = 1.6,
    LineCount = 128,
    FrameJitter = 1.25,
