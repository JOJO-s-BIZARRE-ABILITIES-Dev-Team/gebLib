...
local Codec = loadInternal("geblib/net_codecs.lua")(Net)
local assertCodec = Codec.Assert
local bitsForUnsigned = Codec.BitsForUnsigned
local bitsForSigned = Codec.BitsForSigned
local isNumber = Codec.IsNumber
local isString = Codec.IsString
local isTable = Codec.IsTable
local isFunction = Codec.IsFunction
local isBoolean = Codec.IsBoolean
local isFinite = Codec.IsFinite
local isInteger = Codec.IsInteger
