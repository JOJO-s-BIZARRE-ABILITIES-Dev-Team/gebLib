...
--------------------------
// DEBUGGING
CreateConVar("geblib_developer_debugmode", 0, { FCVAR_REPLICATED, FCVAR_ARCHIVE, FCVAR_PROTECTED },
	"[DEVELOPER] Debug Mode")
CreateConVar("geblib_developer_debugnetwork", 0, { FCVAR_REPLICATED, FCVAR_ARCHIVE, FCVAR_PROTECTED },
	"[DEVELOPER] Displays network debug messages")

function gebLib.DebugMode()
	return GetConVar("geblib_developer_debugmode"):GetBool()
end

function gebLib.asdsad()
	return GetConVar("geblib_developer_debugmode"):GetBool()
end
